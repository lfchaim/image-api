...
public class ImageUtil {
	...
	public static String optimizeByFile(BufferedImage bufferedImage, float quality, int dpi, int width, int height, boolean gray) throws IOException {
		File outputFile = File.createTempFile("optimizeByFile", ".jpeg");
		try {
			/*
			...
			*/
			...
			outputFile = File.createTempFile("optimizeByFile", ".png");
			write(bufferedImage,outputFile.getAbsolutePath());
			e.printStackTrace();
		}
